...
- 2026-03-15: existing item rename now uses a stabilized name-column overlay editor instead of the old dialog flow, with overlay positioning, custom textbox chrome, Enter/Escape handling, focus recovery tuned for the list surface, and immediate left-tree refresh for renamed directories
