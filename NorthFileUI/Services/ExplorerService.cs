...
public sealed class ExplorerService
{
    ...
    public async Task<List<NorthFileUI.SidebarTreeEntry>> EnumerateSidebarDirectoriesAsync(string path, CancellationToken cancellationToken, int maxChildren)
    {
        return await Task.Run(
            () =>
            {
                var list = new List<NorthFileUI.SidebarTreeEntry>();
                try
                {
                    foreach (string dir in Directory.EnumerateDirectories(path))
                    {
                        ...
                        list.Add(new NorthFileUI.SidebarTreeEntry(name, dir));
    ...
    public List<NorthFileUI.SidebarTreeEntry> EnumerateSidebarDirectories(string path, int maxChildren)
    {
        var list = new List<NorthFileUI.SidebarTreeEntry>();
        try
        {
